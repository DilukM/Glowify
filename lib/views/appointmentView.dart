...
class _AppointmentViewState extends State<AppointmentView> {
  ...
  Widget build(BuildContext context) {
    List<SalonModel> featuredSalons = salons.where((salon) => salon.isFeatured).toList();
    List<SalonModel> regularSalons = salons.where((salon) => !salon.isFeatured).toList();
    ...
    return Scaffold(
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return RegularSalonCard(salon: regularSalons[index], isImageOnRight: isEven);
                  },
                ),
              ),
            ],
      ...
      bottomNavigationBar: BottomNavigationBar(
        selectedItemColor: Color(0xFFE5A126),
        unselectedItemColor: Color(0xFFE5A126),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: Color(0xFFE5A126),
